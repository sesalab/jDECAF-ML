...
import weka.OptimisticClassifier;
import weka.PessimisticClassifier;
import weka.RandomClassifier;
 ...
 * @author fabiano
 */
public class BaselineClassifiers {

    public BaselineClassifiers(String predictorsFilePath, String outputFilePath, int rep) {
        ...
        try {
            ...
            Logger.getLogger(BaselineClassifiers.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private static void evaluateModel(String predictorsFilePath, String outputFilePath, Instances pInstances, int rep) throws FileNotFoundException, Exception {
        ...
        classifiers.add(new OptimisticClassifier());
        classifiers.add(new PessimisticClassifier());
        classifiers.add(new RandomClassifier());
