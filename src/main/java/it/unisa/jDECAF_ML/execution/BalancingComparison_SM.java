 ...
 * @author fabiano
 */
public class BalancingComparison_SM {

    public BalancingComparison_SM(String predictorsFilePath, String outputFilePath, String overlapFilePath, Classifier classifier, int rep, List<ClassBean> classes, List<MethodBean> methods, boolean classSmell, DetectionRule dr) {
...
//                    }
            ...
            output += "SM;" +r+ ";" + tp + ";" + fp + ";" + fn + ";" + tn + ";" + accuracy + ";" + precision + ";" + recall + ";" + fmeasure + ";" + auc + ";" + MCC + ";" + maxIndex + ";" + enlapsedTime + "\n";
            failed = false;
