 ...
 * @author fabiano
 */
public class BalancingComparison_CB {

    public BalancingComparison_CB(String predictorsFilePath, String outputFilePath, String overlapFilePath, Classifier classifier, int rep, List<ClassBean> classes, List<MethodBean> methods, boolean classSmell, DetectionRule dr) {
...
//                    }
            ...
            output += "CB;"+r+ ";" + tp + ";" + fp + ";" + fn + ";" + tn + ";" + accuracy + ";" + precision + ";" + recall + ";" + fmeasure + ";" + auc + ";" + MCC + ";" + maxIndex + ";" + enlapsedTime + "\n";
            failed = false;
