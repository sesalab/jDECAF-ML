 ...
 * @author fabiano
 */
public class BalancingComparison_OCC {

    public BalancingComparison_OCC(String predictorsFilePath, String outputFilePath, String overlapFilePath, Classifier classifier, int rep, List<ClassBean> classes, List<MethodBean> methods, boolean classSmell, DetectionRule dr) {
...
//                    }
            ...
            output += "OCC;" +r+ ";" + tp + ";" + fp + ";" + fn + ";" + tn + ";" + accuracy + ";" + precision + ";" + recall + ";" + fmeasure + ";" + auc + ";" + MCC + ";" + maxIndex + ";" + enlapsedTime + "\n";
            failed = false;
